...
private:
    ...
    */
    ...
    /**
    *The Textbox that will displayed after
    */
    Textbox Text(intro);
    /**
    *The instance of Window that will be used to display to the user
    */
    Window MainWindow(Text);
    /**
    *used to keep track of the choice from the user for the main menu
    */
    char firstInput;
